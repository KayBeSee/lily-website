...
export const meta = {
    title: 'Lily Wallet v1.2 adds transaction descriptions, address tags, and coin selection',
...
<div className="my-8">
    <img src={headerImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
</div>
...
<div className="my-8">
    <img src={transactionDescription.src} alt="Lily Wallet transaction description screenshot" className="rounded-md shadow dark:border dark:border-slate-900/40"/>
</div>
...
<div className="my-8">
    <img src={addressTag.src} alt="Lily Wallet address tags screenshot" className="rounded-md shadow dark:border dark:border-slate-900/40"/>
</div>
...
<div className="my-8">
    <img src={coinSelectionScreenshot.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
</div>
...
<div className="my-8">
    <img src={searchScreenshot.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
</div>
