...
import headerImage from '../2022-11-01-lily-release-v1.2/img/header.png'
...
<figure>
    <img src={paperWalletImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
<figcaption className="flex"><InfoButton />A paper wallet generated on bitaddress.org circa 2011</figcaption>
</figure>
...
<figure>
    <img src={ledgerImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
<figcaption className="flex"><InfoButton />The introduction of hardware wallets was a major leap forward for bitcoin security and user experience.</figcaption>
</figure>
...
<figure>
    <img src={singleSigImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
<figcaption className="flex"><InfoButton />In a single signature setup, funds cannot be accessed if the private key is lost or stolen.</figcaption>
</figure>
...
<figure>
    <img src={multisigImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
<figcaption className="flex"><InfoButton />A multisignature setup provides resilience by allowing funds to be moved even if a private key is lost or stolen.</figcaption>
</figure>
...
<figure>
    <img src={vaultSetupImage.src} alt="Lily Wallet v1.2 Header" className="rounded-2xl"/>
    <figcaption className="flex"><InfoButton />Using Lily Wallet makes it easy to create multisignature vaults to protect your bitcoin.</figcaption>
</figure>
