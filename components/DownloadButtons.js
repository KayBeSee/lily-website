...
const DownloadButtons = () => {
  return (
    <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
      <a
        href="https://github.com/Lily-Technologies/lily-wallet/releases/download/v1.0.3/Lily.Wallet.Setup.1.0.3.exe"
      ...
      >
        ...
        <div className="flex flex-col mt-4 items-center justify-center">
          ...
          <span className="text-gray-500 text-xxs sm:text-xs">
            Lily.Wallet.Setup.1.0.3.exe
          </span>
        </div>
      </a>
      <a
        href="https://github.com/Lily-Technologies/lily-wallet/releases/download/v1.0.3/Lily.Wallet-1.0.3.AppImage"
        className="col-span-1 flex justify-center py-8 px-2 sm:px-8 bg-gray-50 flex-col items-center mx-4 my-4 shadow-md rounded-2xl hover:-translate-y-1 transform duration-500 ease-in-out"
      >
        <div>
        ...
        <div className="flex flex-col mt-4 items-center justify-center">
          <span>Linux</span>
          <span className="text-gray-500 text-xxs sm:text-xs">
            Lily.Wallet-1.0.3.AppImage
          </span>
        </div>
      </a>
      <a
        href="https://github.com/Lily-Technologies/lily-wallet/releases/download/v1.0.3/Lily.Wallet-1.0.3.dmg"
        className="col-span-1 flex justify-center py-8 px-2 sm:px-8 bg-gray-50 flex-col items-center mx-4 my-4 shadow-md rounded-2xl hover:-translate-y-1 transform duration-500 ease-in-out"
      >
        <div>
